    ...
    <div class="container">
        ...
        <form action="">
            <div class="form-group">
                <label for="InputTest1">Testimoni</label>
                <textarea name="" class="form-control" id="InputTest1" rows="3"></textarea>
            </div>

            <div class="form-group" id="rating-abillity-wraper">
                ...
                <button class="btnrating btn-default btn-lg" data-attr="1" id="rating-star-1">
